            ...
            <div class="lg:col-span-2 lg:col-start-1 lg:row-start-1 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
              <div class="lg:pr-4">
                <div class="lg:max-w-lg">
                  ...
                  <h1 class="mt-2 text-3xl font-audiowide tracking-tight text-black sm:text-4xl">The Sport</h1>
                ...
                <div class="max-w-xl text-base leading-7 text-gray-700 lg:max-w-lg">
                  ...
                  <ul role="list" class="mt-8 space-y-8 text-gray-600">
                    ...
                    <li class="flex gap-x-3">
                      ...
                      <span><strong class="font-audiowide text-black">Strategy:</strong> Drivers have access to ERS at any point in the race as long as they have enough charge to use it. ERS consists of two main units; The MGU-H, which harvests thermal energy from exhaust fumes & the MGU-K, which harvests kinetic energy from the crankshaft while braking or coasting. Drivers can choose strategically when to activate the system for either attacking or defending.</span>
                    </li>
                    <li class="flex gap-x-3">
                      <svg class="mt-1 h-5 w-5 flex-none text-red-600"  width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z"/>  <path d="M6 5h12l3 5l-8.5 9.5a.7 .7 0 0 1 -1 0l-8.5 -9.5l3 -5" />  <path d="M10 12l-2 -2.2l.6 -1" />
                      </svg>
                      <span><strong class="font-audiowide text-black">Pit Stops:</strong> F1 is the most exclusive sport in the world. It's the only sport of its kind, with the fastest and most innovative racing technology available, it doesnt get more unique. The sport only boasts 24 events throughout the year, compared to the world cup which has 104 games. Only the 20 best drivers in the world can redeem a spot in the sport, solidifying it as the hardest sport to get into.</span>
                    </li>
                    <li class="flex gap-x-3">
                      <svg class="mt-1 h-5 w-5 flex-none text-red-600"  width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        <path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z" />  <line x1="12" y1="9" x2="12" y2="13" />  <line x1="12" y1="17" x2="12.01" y2="17" />
                      </svg>
                      <span><strong class="font-audiowide text-black">Roles:</strong> F1 is one of the most dangerous sports in the world. The rocket ships of cars reach speeds of 220 mph on long straights and sustain up to 5g's on high speed corners. The battles on track pose danger to drivers due to the proximity that they race at, and a small impact can send drivers flying into walls (Max Verstappens 51g crash in Silverstone after coliding with hamilton).</span>
                    </li>
                    <li class="flex gap-x-3">
                      <svg class="mt-1 h-5 w-5 flex-none text-red-600"  width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z"/> <circle cx="12" cy="12" r="9" /> <path d="M14.8 9a2 2 0 0 0 -1.8 -1h-2a2 2 0 0 0 0 4h2a2 2 0 0 1 0 4h-2a2 2 0 0 1 -1.8 -1" /> <path d="M12 6v2m0 8v2" />
                      </svg>
                      <span><strong class="font-audiowide text-black">Teamwork:</strong> F1 is the most expensive sport in the world, with the cars being worth upwards of £15,000,000 and parts like the steering wheel are £50,000. Each team has £135,000,000 to spend a year for upgrading the car to reach its potential. Drivers have huge paychecks ranging from £1,000,000 for the lesser drivers and £55,000,000 for drivers like Lewis Hamilton.</span>
                    </li>
                  </ul>
                  <p class="mt-8">Et vitae blandit facilisi magna lacus commodo. Vitae sapien duis odio id et. Id blandit molestie auctor fermentum dignissim. Lacus diam tincidunt ac cursus in vel. Mauris varius vulputate et ultrices hac adipiscing egestas. Iaculis convallis ac tempor et ut. Ac lorem vel integer orci.</p>
                  <h2 class="mt-16 text-2xl font-audiowide tracking-tight text-black">No server? No problem.</h2>
