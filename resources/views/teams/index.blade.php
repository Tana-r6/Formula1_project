        ...
        @foreach($teams as $team)
          <a href="/teams/{{ $team['id']}}" class="group relative">
            <div class="pb-20">
              ...
              <div class="grid grid-cols-2 max-h-[70px] min-w-[570px] max-w-[584px] absolute top-[{{ $team->size }}px] border-l-2 border-t-2 border-black group-hover:border-{{ $team->colour }} rounded-tl-lg">
                <div>  
